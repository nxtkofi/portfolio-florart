  ...
  return (
    <>
      ...
      <div className="flex relative items-center justify-center h-64">
        ...
        <p className="text-3xl montserrat font-extralight absolute z-20 text-center">
          Zamów swój wymarzony obraz już teraz
        </p>
        <p className="text-lg underline montserrat font- absolute z-20 mt-28 md:mt-16">
          Więcej
        </p>
      </div>
      <div className="background-primary p-4 sm:p-8 text-center flex justify-center items-center">
        <div className="flex flex-col lg:flex-row items-center">
          <div className="flex flex-col items-center justify-center">
            ...
            <div className="montserrat px-6 sm:px-8 py-6 sm:py-8 max-w-xs sm:max-w-md md:max-w-lg bg-white text-center ">
              ...
              <p className="text-lg sm:text-xl mt-3 sm:mt-4 montserrat underline cursor-pointer">
                Więcej
              </p>
            </div>
          </div>
